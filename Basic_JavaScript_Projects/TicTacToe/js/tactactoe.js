...
function placeXorO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            //If activesPlayer is equal to 'O', the o.png is placed in HTML
...
function checkWinConditions() {
    ...
    //X 3,6,0 condition
    else if (arrayIncludes('3X', '6X', '0X')) { drawWinLine(100, 50, 100, 558)}
    //X 1,4,7 condition
    ...
    //O 3,6,0 condition
    else if (arrayIncludes('3O', '6O', '0O')) { drawWinLine(100, 50, 100, 558)}
    //O 1,4,7 condition
    ...
    //This condition checks for a tie. if none of the above conditions are met and the
...
function audio(audioURL) {
    //we create a new radio object and we pass the path as a parameter
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //this line indicates where the start of a lines x axie is
    let x1 = coordX1,
